...
$CFG->dbtype    = 'mysqlii';      // 'pgsql', 'mariadb', 'mysqli', 'sqlsrv' or 'oci'
$CFG->dblibrary = 'native';     // 'native' only at the moment
$CFG->dbhost    = 'localhost';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'moodle';     // database name, eg moodle
$CFG->dbuser    = 'moodledude';   // your database username
$CFG->dbpass    = 'passwordformoodledude';   // your database password
...
$CFG->wwwroot   = 'http://120.72.85.201';
